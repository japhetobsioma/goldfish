...
/// wandering behavior.
/// </summary>
public class AISeahorse : MonoBehaviour
{
    ...
    void Awake()
    {
        SaveSystemSeahorse.fishesSeahorse.Add(this);
    }

    void Start()
    {
        //Find the tankCenterGoal.
        tankCenterGoal = GameObject.Find("Tank Center").transform;
